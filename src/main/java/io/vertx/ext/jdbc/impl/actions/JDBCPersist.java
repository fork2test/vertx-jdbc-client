 ...
 */
  ...
  public JDBCPersist(Vertx vertx, JDBCStatementHelper helper, Connection connection, ContextInternal ctx, TaskQueue statementsQueue, int timeout, JsonObject params, String table) {
